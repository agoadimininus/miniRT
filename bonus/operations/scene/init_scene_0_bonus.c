...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   init_scene_0_bonus.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: cfico-vi <cfico-vi@student.42sp.org.br>    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/06/10 17:43:40 by cfico-vi          #+#    #+#             */
/*   Updated: 2021/08/09 10:42:23 by cfico-vi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_rt	create_scene_and_render(t_rt *rt, t_parse *parse)
{
	...
	rt->cam_count = parse->check_qty[CAMERA];
...
static t_rt	*push_elements_hub(t_rt *rt, t_parse *parse)
{
	...
	else if (parse->ele_list->id == SQUARE)
		rt = push_square(rt, parse);
...
static t_rt	*push_ambient(t_rt *rt, t_parse *parse)
{
	...
	rt->world.lights[0].intensity = color;
	return (rt);
}
